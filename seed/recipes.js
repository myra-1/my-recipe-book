  ...
  const recipes = [
    {
      ...
      cook_time: "8 min",
      serves: "4 people",
      ingredients: ["1 1/2 pounds 80% lean 20% fat ground beef", "1 tbsp Worcestershire sauce", "1 1/2 tsp seasoning salt", "1 tsp garlic powder", "1/2 tsp ground black pepper", "4 slices of cheese", "4 hamburger buns", "optional: hamburger toppings - lettuce tomato, onion, pickles, ketchup, mustard, mayo, etc."],
    ...
    },
    {
      ...
      course: "lunch/dinner",
      serves: "8 people",
      ingredients: ["1/4 cup (1/2 stick) unsalted butter", "10 sprigs thyme, tied together", "1 medium onion, thinly sliced", "2 garlic cloves, thinly sliced", "1/4 cup tomato paste", "2 28-oz. cans whole tomatoes", "1–2 tsp sugar, divided", "1/4 cup (or more) heavy cream", "kosher salt and freshly ground black pepper"],
      instructions: ["Melt butter in a large heavy pot over medium heat.", "Add thyme, onion, and garlic. Cook until onion is completely soft and translucent, 10–12 minutes.",
        ...
        "Add tomatoes with juices, 1 tsp. sugar, and 8 cups water to pot. Increase heat to high; bring to a simmer. Reduce heat to medium. Simmer until flavors meld and soup reduces to about 2 quarts (8 cups), 45–55 minutes.",
        "Remove soup from heat; let cool slightly. Discard thyme sprigs.",
        "Working in small batches, purée soup in a blender until smooth. Return to pot.",
    ...
    },
    {
      ...
      ingredients: ["2 cups flour", "3 tbsp sugar", "1/2 tsp salt", "1 tbsp baking powder", "2 eggs, beaten separately before adding to mixture", "1/4 cup butter, melted", "1 3/4 cups milk"],
      instructions: ["Mix the dry items first. Make a well in the center and pour in the milk, egg and melted butter; mix until smooth.", "Heat a lightly oiled griddle or frying pan over medium high heat. Pour or scoop the batter onto the griddle, using approximately 1/4 cup for each pancake. Brown on both sides and serve hot."]
    }
  ]
